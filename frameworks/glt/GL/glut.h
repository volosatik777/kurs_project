...
// NS
/* Mouse single click or double click. */
#define GLUT_SINGLE_CLICK	0
#define GLUT_DOUBLE_CLICK	1
...
// NS
// Proposed extension for double-click support
GLUTAPI void APIENTRY glutMenuPopupMode(int mode);
