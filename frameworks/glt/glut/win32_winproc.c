    ...
    case WM_KEYDOWN:
        ...
        if (window->special) {
            ...
            case VK_INSERT:
                ...
                break;
            case VK_DELETE:
                /* Delete is an ASCII character, so handle it as a normal
                   keyboard callback (but only if we've got a keyboard 
                   callback. */
                if ( window->keyboard )
                {
                    goto handleDelete;
            ...
            case WM_RBUTTONDOWN:
				{
					...
					switch (msg)
					{
						case WM_LBUTTONDBLCLK:	button = GLUT_LEFT_BUTTON;   click = GLUT_DOUBLE_CLICK; break;
						case WM_MBUTTONDBLCLK:	button = GLUT_MIDDLE_BUTTON; click = GLUT_DOUBLE_CLICK; break;
						case WM_RBUTTONDBLCLK:	button = GLUT_RIGHT_BUTTON;  click = GLUT_DOUBLE_CLICK; break;
						case WM_LBUTTONDOWN:	button = GLUT_LEFT_BUTTON;   click = GLUT_SINGLE_CLICK; break;
						case WM_MBUTTONDOWN:	button = GLUT_MIDDLE_BUTTON; click = GLUT_SINGLE_CLICK; break;
						case WM_RBUTTONDOWN:	button = GLUT_RIGHT_BUTTON;  click = GLUT_SINGLE_CLICK; break;
						default:
					...
					if (window) {
						...
						/* Only popup menu if attached and click matches popup-menu mode */
						if (menu && click==__glutMenuPopupMode) 
						{
